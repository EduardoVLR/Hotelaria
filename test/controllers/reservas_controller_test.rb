...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { dataEntrada: @reserva.dataEntrada, dataSaida: @reserva.dataSaida, quarto: @reserva.quarto } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { dataEntrada: @reserva.dataEntrada, dataSaida: @reserva.dataSaida, quarto: @reserva.quarto } }
